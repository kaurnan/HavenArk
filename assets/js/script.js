...
$('.testi_wrap').slick({
    ...
    centeredSlides: true,
  initialSlide: 1,
    prevArrow: "<button type='button' class='slick-prev pull-left'><img src='assets/images/left-arrow.png' alt='left-arrow'></button>",
    nextArrow: "<button type='button' class='slick-next pull-right'><img src='assets/images/right-arrow.png' alt='right-arrow'></button>",
    responsive: [{
        breakpoint: 1024,
        settings: {
            slidesToShow: 1,
